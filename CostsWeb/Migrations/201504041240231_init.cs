namespace CostsWeb.Migrations
{
    ...
    public partial class init : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.CostsJournals", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.CostsJournals", "SubCategoryId", "dbo.Categories");
            ...
            DropIndex("dbo.CostsJournals", new[] { "UserId" });
            DropIndex("dbo.CostsJournals", new[] { "SubCategoryId" });
